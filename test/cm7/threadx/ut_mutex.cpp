...
//     static const ULONG STACK_SIZE = 1024;
//     uint8_t* stack1 = new uint8_t[STACK_SIZE];
//     uint8_t* stack2 = new uint8_t[STACK_SIZE];
...
//                           STACK_SIZE,
//                           5,                  // Example priority
//                           etl::optional<UINT>(), // No preemption threshold provided (defaults to priority)
//                           TX_NO_TIME_SLICE,
//                           TX_AUTO_START);
...
//                           STACK_SIZE,
//                           5,                  // Example priority
//                           etl::optional<UINT>(), // Defaults to priority
//                           TX_NO_TIME_SLICE,
//                           TX_AUTO_START);
