...
union DR {
  ...
  static inline volatile DR &Instance() {
    return *reinterpret_cast<volatile DR*>(0x40C64000);
  }
...
union GDIR {
  ...
  static inline volatile GDIR &Instance() {
    return *reinterpret_cast<volatile GDIR*>(0x40C64004);
  }
...
union PSR {
  ...
  static inline volatile PSR &Instance() {
    return *reinterpret_cast<volatile PSR*>(0x40C64008);
  }
...
union ICR1 {
  ...
  static inline volatile ICR1 &Instance() {
    return *reinterpret_cast<volatile ICR1*>(0x40C6400C);
  }
...
union ICR2 {
  ...
  static inline volatile ICR2 &Instance() {
    return *reinterpret_cast<volatile ICR2*>(0x40C64010);
  }
...
union IMR {
  ...
  static inline volatile IMR &Instance() {
    return *reinterpret_cast<volatile IMR*>(0x40C64014);
  }
...
union ISR {
  ...
  static inline volatile ISR &Instance() {
    return *reinterpret_cast<volatile ISR*>(0x40C64018);
  }
...
union EDGE_SEL {
  ...
  static inline volatile EDGE_SEL &Instance() {
    return *reinterpret_cast<volatile EDGE_SEL*>(0x40C6401C);
  }
...
union DR_SET {
  ...
  static inline volatile DR_SET &Instance() {
    return *reinterpret_cast<volatile DR_SET*>(0x40C64084);
  }
...
union DR_CLEAR {
  ...
  static inline volatile DR_CLEAR &Instance() {
    return *reinterpret_cast<volatile DR_CLEAR*>(0x40C64088);
  }
...
union DR_TOGGLE {
  ...
  static inline volatile DR_TOGGLE &Instance() {
    return *reinterpret_cast<volatile DR_TOGGLE*>(0x40C6408C);
  }
