...
union VERID {
    ...
    static inline volatile VERID &Instance() {
        return *reinterpret_cast<volatile VERID*>(0x4007C000);
    }
...
union PARAM {
    ...
    static inline volatile PARAM &Instance() {
        return *reinterpret_cast<volatile PARAM*>(0x4007C004);
    }
...
union GLOBAL {
    ...
    static inline volatile GLOBAL &Instance() {
        return *reinterpret_cast<volatile GLOBAL*>(0x4007C008);
    }
...
union PINCFG {
    ...
    static inline volatile PINCFG &Instance() {
        return *reinterpret_cast<volatile PINCFG*>(0x4007C00C);
    }
...
union BAUD {
    ...
    static inline volatile BAUD &Instance() {
        return *reinterpret_cast<volatile BAUD*>(0x4007C010);
    }
...
union STAT {
    ...
    static inline volatile STAT &Instance() {
        return *reinterpret_cast<volatile STAT*>(0x4007C014);
    }
...
union CTRL {
    ...
    static inline volatile CTRL &Instance() {
        return *reinterpret_cast<volatile CTRL*>(0x4007C018);
    }
...
union DATA {
    ...
    static inline volatile DATA &Instance() {
        return *reinterpret_cast<volatile DATA*>(0x4007C01C);
    }
...
union MATCH {
    ...
    static inline volatile MATCH &Instance() {
        return *reinterpret_cast<volatile MATCH*>(0x4007C020);
    }
...
union MODIR {
    ...
    static inline volatile MODIR &Instance() {
        return *reinterpret_cast<volatile MODIR*>(0x4007C024);
    }
...
union FIFO {
    ...
    static inline volatile FIFO &Instance() {
        return *reinterpret_cast<volatile FIFO*>(0x4007C028);
    }
...
union WATER {
    ...
    static inline volatile WATER &Instance() {
        return *reinterpret_cast<volatile WATER*>(0x4007C02C);
    }
