...
union BPC_AUTHEN_CTRL {
  ...
  static inline volatile BPC_AUTHEN_CTRL &Instance() { return *reinterpret_cast<volatile BPC_AUTHEN_CTRL*>(0x40C88C04); }
};
...
union BPC_MODE {
  ...
  static inline volatile BPC_MODE &Instance() { return *reinterpret_cast<volatile BPC_MODE*>(0x40C88C10); }
};
...
union BPC_POWER_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_POWER_CTRL &Instance() { return *reinterpret_cast<volatile BPC_POWER_CTRL*>(0x40C88C14); }
};
...
union BPC_FLAG {
  ...
  BPC_FLAG() = delete;
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_FLAG &Instance() { return *reinterpret_cast<volatile BPC_FLAG*>(0x40C88C2C); }
};
...
union BPC_SSAR_SAVE_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_SSAR_SAVE_CTRL &Instance() { return *reinterpret_cast<volatile BPC_SSAR_SAVE_CTRL*>(0x40C88C40); }
};
...
union BPC_SSAR_RESTORE_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_SSAR_RESTORE_CTRL &Instance() { return *reinterpret_cast<volatile BPC_SSAR_RESTORE_CTRL*>(0x40C88C44); }
};
