...
struct AnadigMisc {
  ...
  struct MISC_DIFPROG : ftl::mmio::Register<
      ...
      0x001170B0u,
      ftl::mmio::RO,
      MiscDifprogFields::CHIPID> {
    using CHIPID = MiscDifprogFields::CHIPID;
  };

  // VDDSOC_AI_CTRL_REGISTER
  struct VddsocAiCtrlFields {
    // VDDSOC_AI_ADDR
  ...
  struct VDDSOC_AI_CTRL : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddsocAiCtrlFields::VDDSOC_AI_ADDR,
      ftl::mmio::Reserved<8, 8>,
      VddsocAiCtrlFields::VDDSOC_AIRWB,
      ftl::mmio::Reserved<15, 17>> {
    using VDDSOC_AI_ADDR = VddsocAiCtrlFields::VDDSOC_AI_ADDR;
    using VDDSOC_AIRWB = VddsocAiCtrlFields::VDDSOC_AIRWB;
  };

  // VDDSOC_AI_WDATA_REGISTER
  struct VddsocAiWdataFields {
    // VDDSOC_AI_WDATA
  ...
  struct VDDSOC_AI_WDATA : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddsocAiWdataFields::VDDSOC_AI_WDATA> {
    using VALUE = VddsocAiWdataFields::VDDSOC_AI_WDATA;
  };

  // VDDSOC_AI_RDATA_REGISTER
  struct VddsocAiRdataFields {
    // VDDSOC_AI_RDATA
  ...
  struct VDDSOC_AI_RDATA : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      VddsocAiRdataFields::VDDSOC_AI_RDATA> {
    using VALUE = VddsocAiRdataFields::VDDSOC_AI_RDATA;
  };

  // VDDSOC2PLL_AI_CTRL_1G_REGISTER
  struct Vddsoc2pllAiCtrl1gFields {
  ...
  struct VDDSOC2PLL_AI_CTRL_1G : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AIADDR_1G,
      Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AITOGGLE_1G,
      Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AITOGGLE_DONE_1G,
      ftl::mmio::Reserved<6, 10>,
      Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AIRWB_1G,
      ftl::mmio::Reserved<15, 17>> {
    using VDDSOC2PLL_AIADDR_1G = Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AIADDR_1G;
    using VDDSOC2PLL_AITOGGLE_1G = Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AITOGGLE_1G;
    using VDDSOC2PLL_AITOGGLE_DONE_1G = Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AITOGGLE_DONE_1G;
    using VDDSOC2PLL_AIRWB_1G = Vddsoc2pllAiCtrl1gFields::VDDSOC2PLL_AIRWB_1G;
  };

  // VDDSOC2PLL_AI_WDATA_1G_REGISTER
  struct Vddsoc2pllAiWdata1gFields {
  ...
  struct VDDSOC2PLL_AI_WDATA_1G : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiWdata1gFields::VDDSOC2PLL_AI_WDATA_1G> {
    using VALUE = Vddsoc2pllAiWdata1gFields::VDDSOC2PLL_AI_WDATA_1G;
  };

  // VDDSOC2PLL_AI_RDATA_1G_REGISTER
  struct Vddsoc2pllAiRdata1gFields {
  ...
  struct VDDSOC2PLL_AI_RDATA_1G : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      Vddsoc2pllAiRdata1gFields::VDDSOC2PLL_AI_RDATA_1G> {
    using VALUE = Vddsoc2pllAiRdata1gFields::VDDSOC2PLL_AI_RDATA_1G;
  };

  // VDDSOC_AI_CTRL_AUDIO_REGISTER
  struct Vddsoc2pllAiCtrlAudioFields {
  ...
  struct VDDSOC2PLL_AI_CTRL_AUDIO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AI_ADDR_AUDIO,
      Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AITOGGLE_AUDIO,
      Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AITOGGLE_DONE_AUDIO,
      ftl::mmio::Reserved<6, 10>,
      Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AIRWB_AUDIO,
      ftl::mmio::Reserved<15, 17>> {
    using VDDSOC2PLL_AI_ADDR_AUDIO = Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AI_ADDR_AUDIO;
    using VDDSOC2PLL_AITOGGLE_AUDIO = Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AITOGGLE_AUDIO;
    using VDDSOC2PLL_AITOGGLE_DONE_AUDIO = Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AITOGGLE_DONE_AUDIO;
    using VDDSOC2PLL_AIRWB_AUDIO = Vddsoc2pllAiCtrlAudioFields::VDDSOC2PLL_AIRWB_AUDIO;
  };

  // VDDSOC_AI_WDATA_AUDIO_REGISTER
  struct Vddsoc2pllAiWdataAudioFields {
  ...
  struct VDDSOC2PLL_AI_WDATA_AUDIO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiWdataAudioFields::VDDSOC2PLL_AI_WDATA_AUDIO> {
    using VALUE = Vddsoc2pllAiWdataAudioFields::VDDSOC2PLL_AI_WDATA_AUDIO;
  };

  // VDDSOC2PLL_AI_RDATA_REGISTER
  struct Vddsoc2pllAiRdataAudioFields {
  ...
  struct VDDSOC2PLL_AI_RDATA_AUDIO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      Vddsoc2pllAiRdataAudioFields::VDDSOC2PLL_AI_RDATA_AUDIO> {
    using VALUE = Vddsoc2pllAiRdataAudioFields::VDDSOC2PLL_AI_RDATA_AUDIO;
  };

  // VDDSOC2PLL_AI_CTRL_VIDEO_REGISTER
  struct Vddsoc2pllAiCtrlVideoFields {
  ...
  struct VDDSOC2PLL_AI_CTRL_VIDEO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AIADDR_VIDEO,
      Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AITOGGLE_VIDEO,
      Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AITOGGLE_DONE_VIDEO,
      ftl::mmio::Reserved<6, 10>,
      Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AIRWB_VIDEO,
      ftl::mmio::Reserved<15, 17>> {
    using VDDSOC2PLL_AIADDR_VIDEO = Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AIADDR_VIDEO;
    using VDDSOC2PLL_AITOGGLE_VIDEO = Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AITOGGLE_VIDEO;
    using VDDSOC2PLL_AITOGGLE_DONE_VIDEO = Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AITOGGLE_DONE_VIDEO;
    using VDDSOC2PLL_AIRWB_VIDEO = Vddsoc2pllAiCtrlVideoFields::VDDSOC2PLL_AIRWB_VIDEO;
  };

  // VDDSOC2PLL_AI_WDATA_VIDEO_REGISTER
  struct Vddsoc2pllAiWdataVideoFields {
  ...
  struct VDDSOC2PLL_AI_WDATA_VIDEO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      Vddsoc2pllAiWdataVideoFields::VDDSOC2PLL_AI_WDATA_VIDEO> {
    using VALUE = Vddsoc2pllAiWdataVideoFields::VDDSOC2PLL_AI_WDATA_VIDEO;
  };

  // VDDSOC2PLL_AI_RDATA_VIDEO_REGISTER
  struct Vddsoc2pllAiRdataVideoFields {
  ...
  struct VDDSOC2PLL_AI_RDATA_VIDEO : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      Vddsoc2pllAiRdataVideoFields::VDDSOC2PLL_AI_RDATA_VIDEO> {
    using VALUE = Vddsoc2pllAiRdataVideoFields::VDDSOC2PLL_AI_RDATA_VIDEO;
  };

  // VDDSOC_AI_CTRL_REGISTER
  struct VddlpsrAiCtrlFields {
    // VDDLPSR_AI_ADDR
  ...
  struct VDDLPSR_AI_CTRL : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddlpsrAiCtrlFields::VDDLPSR_AI_ADDR,
      ftl::mmio::Reserved<8, 8>,
      VddlpsrAiCtrlFields::VDDLPSR_AIRWB,
      ftl::mmio::Reserved<15, 17>> {
    using VDDLPSR_AI_ADDR = VddlpsrAiCtrlFields::VDDLPSR_AI_ADDR;
    using VDDLPSR_AIRWB = VddlpsrAiCtrlFields::VDDLPSR_AIRWB;
  };

  // VDDLPSR_AI_WDATA_REGISTER
  struct VddlpsrAiWdataFields {
    // VDD_LPSR_AI_WDATA
  ...
  struct VDDLPSR_AI_WDATA : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddlpsrAiWdataFields::VDDLPSR_AI_WDATA> {
    using VALUE = VddlpsrAiWdataFields::VDDLPSR_AI_WDATA;
  };

  // VDDLPSR_AI_RDATA_REFTOP_REGISTER
  struct VddlpsrAiRdataReftopFields {
  ...
  struct VDDLPSR_AI_RDATA_REFTOP : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      VddlpsrAiRdataReftopFields::VDDLPSR_AI_RDATA_REFTOP> {
    using VALUE = VddlpsrAiRdataReftopFields::VDDLPSR_AI_RDATA_REFTOP;
  };

  // VDDLPSR_AI_RDATA_TMPSNS_REGISTER
  struct VddlpsrAiRdataTmpsnsFields {
  ...
  struct VDDLPSR_AI_RDATA_TMPSNS : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      VddlpsrAiRdataTmpsnsFields::VDDLPSR_AI_RDATA_TMPSNS> {
    using VALUE = VddlpsrAiRdataTmpsnsFields::VDDLPSR_AI_RDATA_TMPSNS;
  };

  // VDDLPSR_AI400M_CTRL_REGISTER
  struct VddlpsrAi400mCtrlFields {
    // VDDLPSR_AI400M_ADDR
  ...
  struct VDDLPSR_AI400M_CTRL : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddlpsrAi400mCtrlFields::VDDLPSR_AI400M_ADDR,
      VddlpsrAi400mCtrlFields::VDDLPSR_AITOGGLE_400M,
      VddlpsrAi400mCtrlFields::VDDLPSR_AITOGGLE_DONE_400M,
      ftl::mmio::Reserved<6, 10>,
      VddlpsrAi400mCtrlFields::VDDLPSR_AI400M_RWB,
      ftl::mmio::Reserved<15, 17>> {
    using VDDLPSR_AI400M_ADDR = VddlpsrAi400mCtrlFields::VDDLPSR_AI400M_ADDR;
    using VDDLPSR_AITOGGLE_400M = VddlpsrAi400mCtrlFields::VDDLPSR_AITOGGLE_400M;
    using VDDLPSR_AITOGGLE_DONE_400M = VddlpsrAi400mCtrlFields::VDDLPSR_AITOGGLE_DONE_400M;
    using VDDLPSR_AI400M_RWB = VddlpsrAi400mCtrlFields::VDDLPSR_AI400M_RWB;
  };

  // VDDLPSR_AI400M_WDATA_REGISTER
  struct VddlpsrAi400mWdataFields {
  ...
  struct VDDLPSR_AI400M_WDATA : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RW,
      VddlpsrAi400mWdataFields::VDDLPSR_AI400M_WDATA> {
    using VALUE = VddlpsrAi400mWdataFields::VDDLPSR_AI400M_WDATA;
  };

  // VDDLPSR_AI400M_RDATA_REGISTER
  struct VddlpsrAi400mRdataFields {
  ...
  struct VDDLPSR_AI400M_RDATA : ftl::mmio::Register<
      ...
      0x00000000u,
      ftl::mmio::RO,
      VddlpsrAi400mRdataFields::VDDLPSR_AI400M_RDATA> {
    using VALUE = VddlpsrAi400mRdataFields::VDDLPSR_AI400M_RDATA;
  };
