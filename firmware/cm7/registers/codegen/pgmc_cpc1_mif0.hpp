...
union MIF_AUTHEN_CTRL {
  ...
  static inline volatile MIF_AUTHEN_CTRL &ref() { return *reinterpret_cast<volatile MIF_AUTHEN_CTRL*>(0x40C89504); }
};
...
union MIF_MLPL_SLEEP {
  ...
  static inline volatile MIF_MLPL_SLEEP &ref() { return *reinterpret_cast<volatile MIF_MLPL_SLEEP*>(0x40C89510); }
};
...
union MIF_MLPL_IG {
  ...
  static inline volatile MIF_MLPL_IG &ref() { return *reinterpret_cast<volatile MIF_MLPL_IG*>(0x40C89520); }
};
...
union MIF_MLPL_LS {
  ...
  static inline volatile MIF_MLPL_LS &ref() { return *reinterpret_cast<volatile MIF_MLPL_LS*>(0x40C89530); }
};
...
union MIF_MLPL_HS {
  ...
  static inline volatile MIF_MLPL_HS &ref() { return *reinterpret_cast<volatile MIF_MLPL_HS*>(0x40C89540); }
};
...
union MIF_MLPL_STDBY {
  ...
  static inline volatile MIF_MLPL_STDBY &ref() { return *reinterpret_cast<volatile MIF_MLPL_STDBY*>(0x40C89550); }
};
...
union MIF_MLPL_ARR_PDN {
  ...
  static inline volatile MIF_MLPL_ARR_PDN &ref() { return *reinterpret_cast<volatile MIF_MLPL_ARR_PDN*>(0x40C89560); }
};
...
union MIF_MLPL_PER_PDN {
  ...
  static inline volatile MIF_MLPL_PER_PDN &ref() { return *reinterpret_cast<volatile MIF_MLPL_PER_PDN*>(0x40C89570); }
};
...
union MIF_MLPL_INITN {
  ...
  static inline volatile MIF_MLPL_INITN &ref() { return *reinterpret_cast<volatile MIF_MLPL_INITN*>(0x40C89580); }
};
...
union MIF_MLPL_ISO {
  ...
  static inline volatile MIF_MLPL_ISO &ref() { return *reinterpret_cast<volatile MIF_MLPL_ISO*>(0x40C895B0); }
};
