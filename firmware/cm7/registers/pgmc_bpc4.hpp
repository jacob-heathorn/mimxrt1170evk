...
union BPC_AUTHEN_CTRL {
  ...
  static inline volatile BPC_AUTHEN_CTRL &ref() { return *reinterpret_cast<volatile BPC_AUTHEN_CTRL*>(0x40C88804); }
};
...
union BPC_MODE {
  ...
  static inline volatile BPC_MODE &ref() { return *reinterpret_cast<volatile BPC_MODE*>(0x40C88810); }
};
...
union BPC_POWER_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_POWER_CTRL &ref() { return *reinterpret_cast<volatile BPC_POWER_CTRL*>(0x40C88814); }
};
...
union BPC_FLAG {
  ...
  BPC_FLAG() = delete;
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_FLAG &ref() { return *reinterpret_cast<volatile BPC_FLAG*>(0x40C8882C); }
};
...
union BPC_SSAR_SAVE_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_SSAR_SAVE_CTRL &ref() { return *reinterpret_cast<volatile BPC_SSAR_SAVE_CTRL*>(0x40C88840); }
};
...
union BPC_SSAR_RESTORE_CTRL {
  ...
  inline void Reset() volatile { this->value = 0x00000000; }
  static inline volatile BPC_SSAR_RESTORE_CTRL &ref() { return *reinterpret_cast<volatile BPC_SSAR_RESTORE_CTRL*>(0x40C88844); }
};
