...
union MAC_CONFIGURATION {
  ...
  enum class eFES : uint32_t {
    // 10 Mbps when PS bit is 1 and 1 Gbps when PS bit is 0
    eMbps_10_1000M = 0,
    // 100 Mbps when PS bit is 1 and 2.5 Gbps when PS bit is 0
    eMbps_100_2500M = 1,
  };
  
  // Port Select
  enum class ePS : uint32_t {
    // For 1000 or 2500 Mbps operations
    ebf_1000_2500M = 0,
  ...
  enum class eACS : uint32_t {
    // Automatic Pad or CRC Stripping is disabled
    eDISABLE = 0,
    // Automatic Pad or CRC Stripping is enabled
    eENABLE = 1,
  };
  ...
  enum class eCST : uint32_t {
    // CRC stripping for Type packets is disabled
    eDISABLE = 0,
    // CRC stripping for Type packets is enabled
    eENABLE = 1,
  };
  
  // IEEE 802.
  enum class eS2KP : uint32_t {
    // Support upto 2K packet is disabled
    eDISABLE = 0,
    // Support upto 2K packet is Enabled
    eENABLE = 1,
  };
  
  // Giant Packet Size Limit Control Enable
  enum class eGPSLCE : uint32_t {
    // Giant Packet Size Limit Control is disabled
    eDISABLE = 0,
    // Giant Packet Size Limit Control is enabled
    eENABLE = 1,
  };
  ...
  enum class eIPC : uint32_t {
    // IP header/payload checksum checking is disabled
    eDISABLE = 0,
    // IP header/payload checksum checking is enabled
    eENABLE = 1,
  };
  
  // Source Address Insertion or Replacement Control
  enum class eSARC : uint32_t {
    // mti_sa_ctrl_i and ati_sa_ctrl_i input signals control the SA field generation
    eSA_CTRL_IN = 0,
    // Contents of MAC Addr-0 inserted in SA field
    eMAC0_INS_SA = 2,
    // Contents of MAC Addr-0 replaces SA field
    eMAC0_REP_SA = 3,
    // Contents of MAC Addr-1 inserted in SA field
    eMAC1_INS_SA = 6,
...
union MAC_EXT_CONFIGURATION {
  ...
  enum class eSPEN : uint32_t {
    // Slow Protocol Detection is disabled
    eDISABLE = 0,
    // Slow Protocol Detection is enabled
    eENABLE = 1,
  };
  
  // Unicast Slow Protocol Packet Detect
  enum class eUSP : uint32_t {
    // Unicast Slow Protocol Packet Detection is disabled
    eDISABLE = 0,
    // Unicast Slow Protocol Packet Detection is enabled
    eENABLE = 1,
  };
  
  // Packet Duplication Control
  enum class ePDC : uint32_t {
    // Packet Duplication Control is disabled
    eDISABLE = 0,
    // Packet Duplication Control is enabled
    eENABLE = 1,
  };
  
  // Extended Inter-Packet Gap Enable
  enum class eEIPGEN : uint32_t {
    // Extended Inter-Packet Gap is disabled
    eDISABLE = 0,
...
union MAC_PACKET_FILTER {
  ...
  enum class eHUC : uint32_t {
    // Hash Unicast is disabled
    eDISABLE = 0,
    // Hash Unicast is enabled
    eENABLE = 1,
  };
  
  // Hash Multicast
  enum class eHMC : uint32_t {
    // Hash Multicast is disabled
    eDISABLE = 0,
    // Hash Multicast is enabled
    eENABLE = 1,
  };
  
  // DA Inverse Filtering
  enum class eDAIF : uint32_t {
    // DA Inverse Filtering is disabled
    eDISABLE = 0,
    // DA Inverse Filtering is enabled
    eENABLE = 1,
  };
  
  // Pass All Multicast
  enum class ePM : uint32_t {
    // Pass All Multicast is disabled
    eDISABLE = 0,
  ...
  enum class eSAIF : uint32_t {
    // SA Inverse Filtering is disabled
    eDISABLE = 0,
    // SA Inverse Filtering is enabled
    eENABLE = 1,
  };
  
  // Source Address Filter Enable
  enum class eSAF : uint32_t {
    // SA Filtering is disabled
    eDISABLE = 0,
    // SA Filtering is enabled
    eENABLE = 1,
  };
  
  // Hash or Perfect Filter
  enum class eHPF : uint32_t {
    // Hash or Perfect Filter is disabled
    eDISABLE = 0,
    // Hash or Perfect Filter is enabled
    eENABLE = 1,
  };
  
  // VLAN Tag Filter Enable
  enum class eVTFE : uint32_t {
    // VLAN Tag Filter is disabled
    eDISABLE = 0,
    // VLAN Tag Filter is enabled
    eENABLE = 1,
  };
  
  // Layer 3 and Layer 4 Filter Enable
  enum class eIPFE : uint32_t {
    // Layer 3 and Layer 4 Filters are disabled
    eDISABLE = 0,
    // Layer 3 and Layer 4 Filters are enabled
    eENABLE = 1,
  };
  
  // Drop Non-TCP/UDP over IP Packets
  enum class eDNTU : uint32_t {
    // Forward Non-TCP/UDP over IP Packets
    eFWD = 0,
    // Drop Non-TCP/UDP over IP Packets
    eDROP = 1,
  };
...
union MAC_WATCHDOG_TIMEOUT {
  ...
  enum class ePWE : uint32_t {
    // Programmable Watchdog is disabled
    eDISABLE = 0,
...
union MAC_VLAN_TAG_CTRL {
  ...
  enum class eVTIM : uint32_t {
    // VLAN Tag Inverse Match is disabled
    eDISABLE = 0,
    // VLAN Tag Inverse Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eEVLRXS : uint32_t {
    // VLAN Tag in Rx status is disabled
    eDISABLE = 0,
    // VLAN Tag in Rx status is enabled
    eENABLE = 1,
  };
  
  // VLAN Tag Hash Table Match Enable
  enum class eVTHM : uint32_t {
    // VLAN Tag Hash Table Match is disabled
    eDISABLE = 0,
    // VLAN Tag Hash Table Match is enabled
    eENABLE = 1,
  };
  
  // Enable Double VLAN Processing
  enum class eEDVLP : uint32_t {
    // Double VLAN Processing is disabled
    eDISABLE = 0,
    // Double VLAN Processing is enabled
    eENABLE = 1,
  };
  
  // ERIVLT
  enum class eERIVLT : uint32_t {
    // Inner VLAN tag is disabled
    eDISABLE = 0,
    // Inner VLAN tag is enabled
    eENABLE = 1,
  };
  ...
  enum class eEIVLRXS : uint32_t {
    // Inner VLAN Tag in Rx status is disabled
    eDISABLE = 0,
...
union MAC_VLAN_TAG_DATA {
  ...
  enum class eETV : uint32_t {
    // 16 bit VLAN comparison
    ebf_16BIT = 0,
    // 12 bit VLAN comparison
    ebf_12BIT = 1,
  };
  
  // Disable VLAN Type Comparison
  enum class eDOVLTC : uint32_t {
    // VLAN type comparison is enabled
    eENABLE = 0,
  ...
  enum class eERSVLM : uint32_t {
    // Receive S-VLAN Match is disabled
    eDISABLE = 0,
    // Receive S-VLAN Match is enabled
    eENABLE = 1,
  };
  
  // Enable Inner VLAN Tag Comparison
  enum class eERIVLT : uint32_t {
    // Inner VLAN tag comparison is disabled
    eDISABLE = 0,
  ...
  enum class eDMACHEN : uint32_t {
    // DMA Channel Number is disabled
    eDISABLE = 0,
...
union MAC_VLAN_INCL {
  ...
  enum class eVLP : uint32_t {
    // VLAN Priority Control is disabled
    eDISABLE = 0,
    // VLAN Priority Control is enabled
    eENABLE = 1,
  };
  
  // C-VLAN or S-VLAN
  enum class eCSVL : uint32_t {
    // C-VLAN type (0x8100) is inserted or replaced
    eC_VLAN = 0,
    // S-VLAN type (0x88A8) is inserted or replaced
    eS_VLAN = 1,
  };
  ...
  enum class eCBTI : uint32_t {
    // Channel based tag insertion is disabled
    eDISABLE = 0,
    // Channel based tag insertion is enabled
    eENABLE = 1,
  };
  
  // Read write control
  enum class eRDWR : uint32_t {
    // Read operation of indirect access
    eREAD = 0,
    // Write operation of indirect access
    eWRITE = 1,
  };
  
  // Busy
  enum class eBUSY : uint32_t {
    // Busy status not detected
    eINACTIVE = 0,
...
union MAC_INNER_VLAN_INCL {
  ...
  // C-VLAN or S-VLAN
  enum class eCSVL : uint32_t {
    // C-VLAN type (0x8100) is inserted
    eC_VLAN = 0,
    // S-VLAN type (0x88A8) is inserted
    eS_VLAN = 1,
  };
...
union MAC_Q0_TX_FLOW_CTRL {
  ...
  enum class eFCB_BPA : uint32_t {
    ...
    eDISABLE = 0,
    // Flow Control Busy or Backpressure Activate is enabled
    eENABLE = 1,
  };
...
union MAC_RX_FLOW_CTRL {
  ...
  enum class eUP : uint32_t {
    // Unicast Pause Packet Detect disabled
    eDISABLE = 0,
    // Unicast Pause Packet Detect enabled
    eENABLE = 1,
  };
  
  // Priority Based Flow Control Enable
  enum class ePFCE : uint32_t {
    // Priority Based Flow Control is disabled
    eDISABLE = 0,
...
union MAC_RXQ_CTRL4 {
  ...
  enum class eUFFQE : uint32_t {
    ...
    eDISABLE = 0,
    // Unicast Address Filter Fail Packets Queuing is enabled
    eENABLE = 1,
  };
  
  // Multicast Address Filter Fail Packets Queuing Enable.
  enum class eMFFQE : uint32_t {
    // Multicast Address Filter Fail Packets Queuing is disabled
    eDISABLE = 0,
    // Multicast Address Filter Fail Packets Queuing is enabled
    eENABLE = 1,
  };
  
  // VLAN Tag Filter Fail Packets Queuing Enable
  enum class eVFFQE : uint32_t {
    // VLAN tag Filter Fail Packets Queuing is disabled
    eDISABLE = 0,
...
union MAC_RXQ_CTRL1 {
  ...
  enum class eMCBCQEN : uint32_t {
    // Multicast and Broadcast Queue is disabled
    eDISABLE = 0,
    // Multicast and Broadcast Queue is enabled
    eENABLE = 1,
  };
  
  // Tagged AV Control Packets Queuing Enable.
  enum class eTACPQE : uint32_t {
    // Tagged AV Control Packets Queuing is disabled
    eDISABLE = 0,
...
union MAC_INTERRUPT_STATUS {
  ...
  enum class eRGSMIIIS : uint32_t {
    ...
    eINACTIVE = 0,
    // RGMII or SMII Interrupt Status is active
    eACTIVE = 1,
  };
  
  // PHY Interrupt
  enum class ePHYIS : uint32_t {
    // PHY Interrupt not detected
    eINACTIVE = 0,
    // PHY Interrupt detected
    eACTIVE = 1,
  };
  
  // PMT Interrupt Status
  enum class ePMTIS : uint32_t {
    // PMT Interrupt status not active
    eINACTIVE = 0,
    // PMT Interrupt status active
    eACTIVE = 1,
  };
  
  // LPI Interrupt Status
  enum class eLPIIS : uint32_t {
    // LPI Interrupt status not active
    eINACTIVE = 0,
    // LPI Interrupt status active
    eACTIVE = 1,
  };
  
  // MMC Interrupt Status
  enum class eMMCIS : uint32_t {
    // MMC Interrupt status not active
    eINACTIVE = 0,
    // MMC Interrupt status active
    eACTIVE = 1,
  };
  
  // MMC Receive Interrupt Status
  enum class eMMCRXIS : uint32_t {
    // MMC Receive Interrupt status not active
    eINACTIVE = 0,
    // MMC Receive Interrupt status active
    eACTIVE = 1,
  };
  
  // MMC Transmit Interrupt Status
  enum class eMMCTXIS : uint32_t {
    // MMC Transmit Interrupt status not active
    eINACTIVE = 0,
    // MMC Transmit Interrupt status active
    eACTIVE = 1,
  };
  ...
  enum class eTSIS : uint32_t {
    // Timestamp Interrupt status not active
    eINACTIVE = 0,
    // Timestamp Interrupt status active
    eACTIVE = 1,
  };
  
  // Transmit Status Interrupt
  enum class eTXSTSIS : uint32_t {
    // Transmit Interrupt status not active
    eINACTIVE = 0,
    // Transmit Interrupt status active
    eACTIVE = 1,
  };
  
  // Receive Status Interrupt
  enum class eRXSTSIS : uint32_t {
    // Receive Interrupt status not active
    eINACTIVE = 0,
    // Receive Interrupt status active
    eACTIVE = 1,
  };
  ...
  enum class eMDIOIS : uint32_t {
    // MDIO Interrupt status not active
    eINACTIVE = 0,
    // MDIO Interrupt status active
    eACTIVE = 1,
  };
...
union MAC_INTERRUPT_ENABLE {
  ...
  enum class eRGSMIIIE : uint32_t {
    ...
    eDISABLE = 0,
    // RGMII or SMII Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class ePHYIE : uint32_t {
    // PHY Interrupt is disabled
    eDISABLE = 0,
    // PHY Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class ePMTIE : uint32_t {
    // PMT Interrupt is disabled
    eDISABLE = 0,
    // PMT Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eLPIIE : uint32_t {
    // LPI Interrupt is disabled
    eDISABLE = 0,
    // LPI Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSIE : uint32_t {
    // Timestamp Interrupt is disabled
    eDISABLE = 0,
    // Timestamp Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXSTSIE : uint32_t {
    // Timestamp Status Interrupt is disabled
    eDISABLE = 0,
    // Timestamp Status Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXSTSIE : uint32_t {
    // Receive Status Interrupt is disabled
    eDISABLE = 0,
    // Receive Status Interrupt is enabled
    eENABLE = 1,
  };
...
union MAC_PMT_CONTROL_STATUS {
  ...
  enum class eMGKPKTEN : uint32_t {
    // Magic Packet is disabled
    eDISABLE = 0,
    // Magic Packet is enabled
    eENABLE = 1,
  };
  ...
  enum class eRWKPKTEN : uint32_t {
    // Remote wake-up packet is disabled
    eDISABLE = 0,
    // Remote wake-up packet is enabled
    eENABLE = 1,
  };
  ...
  enum class eGLBLUCAST : uint32_t {
    // Global unicast is disabled
    eDISABLE = 0,
    // Global unicast is enabled
    eENABLE = 1,
  };
  ...
  enum class eRWKPFE : uint32_t {
    // Remote Wake-up Packet Forwarding is disabled
    eDISABLE = 0,
    // Remote Wake-up Packet Forwarding is enabled
    eENABLE = 1,
  };
  ...
  enum class eRWKFILTRST : uint32_t {
    // Remote Wake-Up Packet Filter Register Pointer is not Reset
    eDISABLE = 0,
...
union MAC_LPI_CONTROL_STATUS {
  ...
  enum class eTLPIEX : uint32_t {
    // Transmit LPI exit not detected
    eINACTIVE = 0,
    // Transmit LPI exit detected
    eACTIVE = 1,
  };
  ...
  enum class eRLPIEN : uint32_t {
    // Receive LPI entry not detected
    eINACTIVE = 0,
    // Receive LPI entry detected
    eACTIVE = 1,
  };
  ...
  enum class eRLPIEX : uint32_t {
    // Receive LPI exit not detected
    eINACTIVE = 0,
    // Receive LPI exit detected
    eACTIVE = 1,
  };
  ...
  enum class eTLPIST : uint32_t {
    // Transmit LPI state not detected
    eINACTIVE = 0,
    // Transmit LPI state detected
    eACTIVE = 1,
  };
  ...
  enum class ePLSEN : uint32_t {
    // PHY Link Status is disabled
    eDISABLE = 0,
    // PHY Link Status is enabled
    eENABLE = 1,
  };
  ...
  enum class eLPITXA : uint32_t {
    // LPI Tx Automate is disabled
    eDISABLE = 0,
    // LPI Tx Automate is enabled
    eENABLE = 1,
  };
  ...
  enum class eLPIATE : uint32_t {
    // LPI Timer is disabled
    eDISABLE = 0,
    // LPI Timer is enabled
    eENABLE = 1,
  };
...
union MAC_PHYIF_CONTROL_STATUS {
  ...
  enum class eTC : uint32_t {
    ...
    eDISABLE = 0,
    // Enable Transmit Configuration in RGMII, SGMII, or SMII
    eENABLE = 1,
  };
...
union MAC_DEBUG {
  ...
  enum class eRPESTS : uint32_t {
    ...
    eINACTIVE = 0,
    // MAC GMII or MII Receive Protocol Engine Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTPESTS : uint32_t {
    // MAC GMII or MII Transmit Protocol Engine Status not detected
    eINACTIVE = 0,
    // MAC GMII or MII Transmit Protocol Engine Status detected
    eACTIVE = 1,
  };
...
union MAC_HW_FEATURE0 {
  ...
  enum class ePCSSEL : uint32_t {
    // No PCS Registers (TBI, SGMII, or RTBI PHY interface)
    eINACTIVE = 0,
  ...
  enum class eSMASEL : uint32_t {
    // SMA (MDIO) Interface not selected
    eINACTIVE = 0,
    // SMA (MDIO) Interface selected
    eACTIVE = 1,
  };
  ...
  enum class eRWKSEL : uint32_t {
    // PMT Remote Wake-up Packet Enable option is not selected
    eINACTIVE = 0,
    // PMT Remote Wake-up Packet Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eMGKSEL : uint32_t {
    // PMT Magic Packet Enable option is not selected
    eINACTIVE = 0,
    // PMT Magic Packet Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eMMCSEL : uint32_t {
    // RMON Module Enable option is not selected
    eINACTIVE = 0,
    // RMON Module Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eARPOFFSEL : uint32_t {
    // ARP Offload Enable option is not selected
    eINACTIVE = 0,
    // ARP Offload Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eTSSEL : uint32_t {
    // IEEE 1588-2008 Timestamp Enable option is not selected
    eINACTIVE = 0,
    // IEEE 1588-2008 Timestamp Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eEEESEL : uint32_t {
    // Energy Efficient Ethernet Enable option is not selected
    eINACTIVE = 0,
    // Energy Efficient Ethernet Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eTXCOESEL : uint32_t {
    // Transmit Checksum Offload Enable option is not selected
    eINACTIVE = 0,
    // Transmit Checksum Offload Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eRXCOESEL : uint32_t {
    // Receive Checksum Offload Enable option is not selected
    eINACTIVE = 0,
    // Receive Checksum Offload Enable option is selected
    eACTIVE = 1,
  };
  ...
  enum class eMACADR32SEL : uint32_t {
    // MAC Addresses 32-63 Select option is not selected
    eINACTIVE = 0,
    // MAC Addresses 32-63 Select option is selected
    eACTIVE = 1,
  };
  ...
  enum class eMACADR64SEL : uint32_t {
    // MAC Addresses 64-127 Select option is not selected
    eINACTIVE = 0,
    // MAC Addresses 64-127 Select option is selected
    eACTIVE = 1,
  };
  ...
  enum class eSAVLANINS : uint32_t {
    // Source Address or VLAN Insertion Enable option is not selected
    eINACTIVE = 0,
    // Source Address or VLAN Insertion Enable option is selected
    eACTIVE = 1,
  };
...
union MAC_HW_FEATURE1 {
  ...
  enum class eSPRAM : uint32_t {
    // Single Port RAM feature is not selected
    eINACTIVE = 0,
  ...
  enum class eOSTEN : uint32_t {
    // One-Step Timestamping feature is not selected
    eINACTIVE = 0,
    // One-Step Timestamping feature is selected
    eACTIVE = 1,
  };
  ...
  enum class ePTOEN : uint32_t {
    // PTP Offload feature is not selected
    eINACTIVE = 0,
    // PTP Offload feature is selected
    eACTIVE = 1,
  };
  ...
  enum class eADVTHWORD : uint32_t {
    // IEEE 1588 High Word Register option is not selected
    eINACTIVE = 0,
    // IEEE 1588 High Word Register option is selected
    eACTIVE = 1,
  };
  ...
  enum class eDCBEN : uint32_t {
    // DCB Feature is not selected
    eINACTIVE = 0,
    // DCB Feature is selected
    eACTIVE = 1,
  };
  ...
  enum class eSPHEN : uint32_t {
    // Split Header Feature is not selected
    eINACTIVE = 0,
    // Split Header Feature is selected
    eACTIVE = 1,
  };
  ...
  enum class eTSOEN : uint32_t {
    // TCP Segmentation Offload Feature is not selected
    eINACTIVE = 0,
    // TCP Segmentation Offload Feature is selected
    eACTIVE = 1,
  };
  ...
  enum class eDBGMEMA : uint32_t {
    // DMA Debug Registers option is not selected
    eINACTIVE = 0,
    // DMA Debug Registers option is selected
    eACTIVE = 1,
  };
  
  // AV Feature Enable This bit is set to 1 when the Enable Audio Video Bridging option is selected.
  enum class eAVSEL : uint32_t {
    // AV Feature is not selected
    eINACTIVE = 0,
    // AV Feature is selected
    eACTIVE = 1,
  };
  ...
  enum class eRAVSEL : uint32_t {
    // Rx Side Only AV Feature is not selected
    eINACTIVE = 0,
    // Rx Side Only AV Feature is selected
    eACTIVE = 1,
  };
  ...
  enum class ePOUOST : uint32_t {
    // One Step for PTP over UDP/IP Feature is not selected
    eINACTIVE = 0,
    // One Step for PTP over UDP/IP Feature is selected
    eACTIVE = 1,
  };
...
union MAC_HW_FEATURE3 {
  ...
  enum class eCBTISEL : uint32_t {
    // Enable Queue/Channel based VLAN tag insertion on Tx feature is not selected
    eINACTIVE = 0,
  ...
  enum class eDVLAN : uint32_t {
    // Double VLAN option is not selected
    eINACTIVE = 0,
    // Double VLAN option is selected
    eACTIVE = 1,
  };
  ...
  enum class ePDUPSEL : uint32_t {
    // Broadcast/Multicast Packet Duplication feature is not selected
    eINACTIVE = 0,
...
union MAC_MDIO_ADDRESS {
  ...
  enum class eGOC_1 : uint32_t {
    // GMII Operation Command 1 is disabled
    eDISABLE = 0,
    // GMII Operation Command 1 is enabled
    eENABLE = 1,
  };
  ...
  enum class eSKAP : uint32_t {
    // Skip Address Packet is disabled
    eDISABLE = 0,
    // Skip Address Packet is enabled
    eENABLE = 1,
  };
  ...
  enum class eBTB : uint32_t {
    // Back to Back transactions disabled
    eDISABLE = 0,
    // Back to Back transactions enabled
    eENABLE = 1,
  };
...
union MAC_MMC_CONTROL {
  ...
  enum class eCNTSTOPRO : uint32_t {
    // Counter Stop Rollover is disabled
    eDISABLE = 0,
    // Counter Stop Rollover is enabled
    eENABLE = 1,
  };
  ...
  enum class eCNTPRST : uint32_t {
    // Counters Preset is disabled
    eDISABLE = 0,
    // Counters Preset is enabled
    eENABLE = 1,
  };
  ...
  enum class eCNTPRSTLVL : uint32_t {
    // Full-Half Preset is disabled
    eDISABLE = 0,
    // Full-Half Preset is enabled
    eENABLE = 1,
  };
  ...
  enum class eUCDBC : uint32_t {
    // Update MMC Counters for Dropped Broadcast Packets is disabled
    eDISABLE = 0,
...
union MAC_MMC_RX_INTERRUPT {
  ...
  enum class eRXGBPKTIS : uint32_t {
    ...
    eINACTIVE = 0,
    // MMC Receive Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXGBOCTIS : uint32_t {
    // MMC Receive Good Bad Octet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Good Bad Octet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXGOCTIS : uint32_t {
    // MMC Receive Good Octet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Good Octet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXBCGPIS : uint32_t {
    // MMC Receive Broadcast Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Broadcast Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXMCGPIS : uint32_t {
    // MMC Receive Multicast Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Multicast Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXCRCERPIS : uint32_t {
    // MMC Receive CRC Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive CRC Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXALGNERPIS : uint32_t {
    // MMC Receive Alignment Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Alignment Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXRUNTPIS : uint32_t {
    // MMC Receive Runt Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Runt Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXJABERPIS : uint32_t {
    // MMC Receive Jabber Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Jabber Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXUSIZEGPIS : uint32_t {
    // MMC Receive Undersize Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Undersize Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXOSIZEGPIS : uint32_t {
    // MMC Receive Oversize Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Oversize Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX64OCTGBPIS : uint32_t {
    // MMC Receive 64 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 64 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX65T127OCTGBPIS : uint32_t {
    // MMC Receive 65 to 127 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 65 to 127 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX128T255OCTGBPIS : uint32_t {
    // MMC Receive 128 to 255 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 128 to 255 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX256T511OCTGBPIS : uint32_t {
    // MMC Receive 256 to 511 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 256 to 511 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX512T1023OCTGBPIS : uint32_t {
    // MMC Receive 512 to 1023 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 512 to 1023 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRX1024TMAXOCTGBPIS : uint32_t {
    // MMC Receive 1024 to Maximum Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive 1024 to Maximum Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXUCGPIS : uint32_t {
    // MMC Receive Unicast Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Unicast Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXLENERPIS : uint32_t {
    // MMC Receive Length Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Length Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  
  // MMC Receive Out Of Range Error Packet Counter Interrupt Status.
  enum class eRXORANGEPIS : uint32_t {
    // MMC Receive Out Of Range Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Out Of Range Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXPAUSPIS : uint32_t {
    // MMC Receive Pause Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Pause Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXFOVPIS : uint32_t {
    // MMC Receive FIFO Overflow Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive FIFO Overflow Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXVLANGBPIS : uint32_t {
    // MMC Receive VLAN Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive VLAN Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXWDOGPIS : uint32_t {
    // MMC Receive Watchdog Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Watchdog Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXRCVERRPIS : uint32_t {
    // MMC Receive Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXCTRLPIS : uint32_t {
    // MMC Receive Control Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive Control Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXLPIUSCIS : uint32_t {
    // MMC Receive LPI microsecond Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Receive LPI microsecond Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXLPITRCIS : uint32_t {
    // MMC Receive LPI transition Counter Interrupt Status not detected
    eINACTIVE = 0,
...
union MAC_MMC_TX_INTERRUPT {
  ...
  enum class eTXGBOCTIS : uint32_t {
    ...
    eINACTIVE = 0,
    // MMC Transmit Good Bad Octet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXGBPKTIS : uint32_t {
    // MMC Transmit Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXBCGPIS : uint32_t {
    // MMC Transmit Broadcast Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Broadcast Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXMCGPIS : uint32_t {
    // MMC Transmit Multicast Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Multicast Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX64OCTGBPIS : uint32_t {
    // MMC Transmit 64 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 64 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX65T127OCTGBPIS : uint32_t {
    // MMC Transmit 65 to 127 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 65 to 127 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX128T255OCTGBPIS : uint32_t {
    // MMC Transmit 128 to 255 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 128 to 255 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX256T511OCTGBPIS : uint32_t {
    // MMC Transmit 256 to 511 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 256 to 511 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX512T1023OCTGBPIS : uint32_t {
    // MMC Transmit 512 to 1023 Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 512 to 1023 Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTX1024TMAXOCTGBPIS : uint32_t {
    // MMC Transmit 1024 to Maximum Octet Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit 1024 to Maximum Octet Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXUCGBPIS : uint32_t {
    // MMC Transmit Unicast Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Unicast Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXMCGBPIS : uint32_t {
    // MMC Transmit Multicast Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Multicast Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXBCGBPIS : uint32_t {
    // MMC Transmit Broadcast Good Bad Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Broadcast Good Bad Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXUFLOWERPIS : uint32_t {
    // MMC Transmit Underflow Error Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Underflow Error Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXMCOLGPIS : uint32_t {
    // MMC Transmit Multiple Collision Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
  ...
  enum class eTXGOCTIS : uint32_t {
    // MMC Transmit Good Octet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Good Octet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXGPKTIS : uint32_t {
    // MMC Transmit Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXPAUSPIS : uint32_t {
    // MMC Transmit Pause Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Pause Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXVLANGPIS : uint32_t {
    // MMC Transmit VLAN Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit VLAN Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXOSIZEGPIS : uint32_t {
    // MMC Transmit Oversize Good Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit Oversize Good Packet Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXLPIUSCIS : uint32_t {
    // MMC Transmit LPI microsecond Counter Interrupt Status not detected
    eINACTIVE = 0,
    // MMC Transmit LPI microsecond Counter Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXLPITRCIS : uint32_t {
    // MMC Transmit LPI transition Counter Interrupt Status not detected
    eINACTIVE = 0,
...
union MAC_MMC_RX_INTERRUPT_MASK {
  ...
  enum class eRXGBPKTIM : uint32_t {
    ...
    eDISABLE = 0,
    // MMC Receive Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXGBOCTIM : uint32_t {
    // MMC Receive Good Bad Octet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Good Bad Octet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXGOCTIM : uint32_t {
    // MMC Receive Good Octet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Good Octet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXBCGPIM : uint32_t {
    // MMC Receive Broadcast Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Broadcast Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXMCGPIM : uint32_t {
    // MMC Receive Multicast Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Multicast Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXCRCERPIM : uint32_t {
    // MMC Receive CRC Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive CRC Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXALGNERPIM : uint32_t {
    // MMC Receive Alignment Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Alignment Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXRUNTPIM : uint32_t {
    // MMC Receive Runt Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Runt Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXJABERPIM : uint32_t {
    // MMC Receive Jabber Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Jabber Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXUSIZEGPIM : uint32_t {
    // MMC Receive Undersize Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Undersize Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXOSIZEGPIM : uint32_t {
    // MMC Receive Oversize Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Oversize Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRX64OCTGBPIM : uint32_t {
    // MMC Receive 64 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 64 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRX65T127OCTGBPIM : uint32_t {
    // MMC Receive 65 to 127 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 65 to 127 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRX128T255OCTGBPIM : uint32_t {
    // MMC Receive 128 to 255 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 128 to 255 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRX256T511OCTGBPIM : uint32_t {
    // MMC Receive 256 to 511 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 256 to 511 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRX512T1023OCTGBPIM : uint32_t {
    // MMC Receive 512 to 1023 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 512 to 1023 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  
  // MMC Receive 1024 to Maximum Octet Good Bad Packet Counter Interrupt Mask.
  enum class eRX1024TMAXOCTGBPIM : uint32_t {
    // MMC Receive 1024 to Maximum Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive 1024 to Maximum Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXUCGPIM : uint32_t {
    // MMC Receive Unicast Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Unicast Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXLENERPIM : uint32_t {
    // MMC Receive Length Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Length Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXORANGEPIM : uint32_t {
    // MMC Receive Out Of Range Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Out Of Range Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXPAUSPIM : uint32_t {
    // MMC Receive Pause Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Pause Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXFOVPIM : uint32_t {
    // MMC Receive FIFO Overflow Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive FIFO Overflow Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXVLANGBPIM : uint32_t {
    // MMC Receive VLAN Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive VLAN Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXWDOGPIM : uint32_t {
    // MMC Receive Watchdog Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Watchdog Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXRCVERRPIM : uint32_t {
    // MMC Receive Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXCTRLPIM : uint32_t {
    // MMC Receive Control Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive Control Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXLPIUSCIM : uint32_t {
    // MMC Receive LPI microsecond counter interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Receive LPI microsecond counter interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXLPITRCIM : uint32_t {
    // MMC Receive LPI transition counter interrupt Mask is disabled
    eDISABLE = 0,
...
union MAC_MMC_TX_INTERRUPT_MASK {
  ...
  enum class eTXGBOCTIM : uint32_t {
    ...
    eDISABLE = 0,
    // MMC Transmit Good Bad Octet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXGBPKTIM : uint32_t {
    // MMC Transmit Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXBCGPIM : uint32_t {
    // MMC Transmit Broadcast Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Broadcast Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXMCGPIM : uint32_t {
    // MMC Transmit Multicast Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Multicast Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX64OCTGBPIM : uint32_t {
    // MMC Transmit 64 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 64 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX65T127OCTGBPIM : uint32_t {
    // MMC Transmit 65 to 127 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 65 to 127 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX128T255OCTGBPIM : uint32_t {
    // MMC Transmit 128 to 255 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 128 to 255 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX256T511OCTGBPIM : uint32_t {
    // MMC Transmit 256 to 511 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 256 to 511 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX512T1023OCTGBPIM : uint32_t {
    // MMC Transmit 512 to 1023 Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 512 to 1023 Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTX1024TMAXOCTGBPIM : uint32_t {
    // MMC Transmit 1024 to Maximum Octet Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit 1024 to Maximum Octet Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXUCGBPIM : uint32_t {
    // MMC Transmit Unicast Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Unicast Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXMCGBPIM : uint32_t {
    // MMC Transmit Multicast Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Multicast Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXBCGBPIM : uint32_t {
    // MMC Transmit Broadcast Good Bad Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Broadcast Good Bad Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXUFLOWERPIM : uint32_t {
    // MMC Transmit Underflow Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Underflow Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXSCOLGPIM : uint32_t {
    // MMC Transmit Single Collision Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Single Collision Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXMCOLGPIM : uint32_t {
    // MMC Transmit Multiple Collision Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Multiple Collision Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXDEFPIM : uint32_t {
    // MMC Transmit Deferred Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Deferred Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXLATCOLPIM : uint32_t {
    // MMC Transmit Late Collision Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Late Collision Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXEXCOLPIM : uint32_t {
    // MMC Transmit Excessive Collision Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Excessive Collision Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXCARERPIM : uint32_t {
    // MMC Transmit Carrier Error Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Carrier Error Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXGOCTIM : uint32_t {
    // MMC Transmit Good Octet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Good Octet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXGPKTIM : uint32_t {
    // MMC Transmit Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXEXDEFPIM : uint32_t {
    // MMC Transmit Excessive Deferral Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Excessive Deferral Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXPAUSPIM : uint32_t {
    // MMC Transmit Pause Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Pause Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXVLANGPIM : uint32_t {
    // MMC Transmit VLAN Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit VLAN Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXOSIZEGPIM : uint32_t {
    // MMC Transmit Oversize Good Packet Counter Interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit Oversize Good Packet Counter Interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXLPIUSCIM : uint32_t {
    // MMC Transmit LPI microsecond counter interrupt Mask is disabled
    eDISABLE = 0,
    // MMC Transmit LPI microsecond counter interrupt Mask is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXLPITRCIM : uint32_t {
    // MMC Transmit LPI transition counter interrupt Mask is disabled
    eDISABLE = 0,
...
union MAC_MMC_IPC_RX_INTERRUPT {
  ...
  enum class eRXIPV4UDSBLPIS : uint32_t {
    // MMC Receive IPV4 UDP Checksum Disabled Packet Counter Interrupt Status not detected
    eINACTIVE = 0,
  ...
  enum class eRXIPV4UDSBLOIS : uint32_t {
    // MMC Receive IPV4 UDP Checksum Disabled Octet Counter Interrupt Status not detected
    eINACTIVE = 0,
...
union MAC_L3_L4_CONTROL0 {
  ...
  enum class eL3SAM0 : uint32_t {
    // Layer 3 IP SA Match is disabled
    eDISABLE = 0,
    // Layer 3 IP SA Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL3SAIM0 : uint32_t {
    // Layer 3 IP SA Inverse Match is disabled
    eDISABLE = 0,
    // Layer 3 IP SA Inverse Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL3DAM0 : uint32_t {
    // Layer 3 IP DA Match is disabled
    eDISABLE = 0,
    // Layer 3 IP DA Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL3DAIM0 : uint32_t {
    // Layer 3 IP DA Inverse Match is disabled
    eDISABLE = 0,
    // Layer 3 IP DA Inverse Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL4PEN0 : uint32_t {
    // Layer 4 Protocol is disabled
    eDISABLE = 0,
    // Layer 4 Protocol is enabled
    eENABLE = 1,
  };
  ...
  enum class eL4SPM0 : uint32_t {
    // Layer 4 Source Port Match is disabled
    eDISABLE = 0,
    // Layer 4 Source Port Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL4SPIM0 : uint32_t {
    // Layer 4 Source Port Inverse Match is disabled
    eDISABLE = 0,
    // Layer 4 Source Port Inverse Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL4DPM0 : uint32_t {
    // Layer 4 Destination Port Match is disabled
    eDISABLE = 0,
    // Layer 4 Destination Port Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eL4DPIM0 : uint32_t {
    // Layer 4 Destination Port Inverse Match is disabled
    eDISABLE = 0,
    // Layer 4 Destination Port Inverse Match is enabled
    eENABLE = 1,
  };
  ...
  enum class eDMCHEN0 : uint32_t {
    // DMA Channel Select is disabled
    eDISABLE = 0,
...
union MAC_TIMESTAMP_CONTROL {
  ...
  enum class eTSADDREG : uint32_t {
    // Addend Register is not updated
    eDISABLE = 0,
    // Addend Register is updated
    eENABLE = 1,
  };
  ...
  enum class ePTGE : uint32_t {
    // Presentation Time Generation is disabled
    eDISABLE = 0,
    // Presentation Time Generation is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSENALL : uint32_t {
    // Timestamp for All Packets disabled
    eDISABLE = 0,
    // Timestamp for All Packets enabled
    eENABLE = 1,
  };
  ...
  enum class eTSCTRLSSR : uint32_t {
    // Timestamp Digital or Binary Rollover Control is disabled
    eDISABLE = 0,
    // Timestamp Digital or Binary Rollover Control is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSVER2ENA : uint32_t {
    // PTP Packet Processing for Version 2 Format is disabled
    eDISABLE = 0,
    // PTP Packet Processing for Version 2 Format is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSIPENA : uint32_t {
    // Processing of PTP over Ethernet Packets is disabled
    eDISABLE = 0,
    // Processing of PTP over Ethernet Packets is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSIPV6ENA : uint32_t {
    // Processing of PTP Packets Sent over IPv6-UDP is disabled
    eDISABLE = 0,
    // Processing of PTP Packets Sent over IPv6-UDP is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSIPV4ENA : uint32_t {
    // Processing of PTP Packets Sent over IPv4-UDP is disabled
    eDISABLE = 0,
    // Processing of PTP Packets Sent over IPv4-UDP is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSEVNTENA : uint32_t {
    // Timestamp Snapshot for Event Messages is disabled
    eDISABLE = 0,
    // Timestamp Snapshot for Event Messages is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSMSTRENA : uint32_t {
    // Snapshot for Messages Relevant to Master is disabled
    eDISABLE = 0,
    // Snapshot for Messages Relevant to Master is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSENMACADDR : uint32_t {
    // MAC Address for PTP Packet Filtering is disabled
    eDISABLE = 0,
    // MAC Address for PTP Packet Filtering is enabled
    eENABLE = 1,
  };
  ...
  enum class eCSC : uint32_t {
    // checksum correction during OST for PTP over UDP/IPv4 packets is disabled
    eDISABLE = 0,
    // checksum correction during OST for PTP over UDP/IPv4 packets is enabled
    eENABLE = 1,
  };
  ...
  enum class eESTI : uint32_t {
    // External System Time Input is disabled
    eDISABLE = 0,
    // External System Time Input is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXTSSTSM : uint32_t {
    // Transmit Timestamp Status Mode is disabled
    eDISABLE = 0,
    // Transmit Timestamp Status Mode is enabled
    eENABLE = 1,
  };
  
  // AV 802.
  enum class eAV8021ASMEN : uint32_t {
    // AV 802.1AS Mode is disabled
    eDISABLE = 0,
...
union MAC_TIMESTAMP_STATUS {
  ...
  enum class eTSSOVF : uint32_t {
    ...
    eINACTIVE = 0,
    // Timestamp Seconds Overflow status detected
    eACTIVE = 1,
  };
  ...
  enum class eTSTARGT0 : uint32_t {
    // Timestamp Target Time Reached status not detected
    eINACTIVE = 0,
    // Timestamp Target Time Reached status detected
    eACTIVE = 1,
  };
  ...
  enum class eAUXTSTRIG : uint32_t {
    // Auxiliary Timestamp Trigger Snapshot status not detected
    eINACTIVE = 0,
    // Auxiliary Timestamp Trigger Snapshot status detected
    eACTIVE = 1,
  };
  ...
  enum class eTSTRGTERR0 : uint32_t {
    // Timestamp Target Time Error status not detected
    eINACTIVE = 0,
    // Timestamp Target Time Error status detected
    eACTIVE = 1,
  };
  ...
  enum class eTSTARGT1 : uint32_t {
    // Timestamp Target Time Reached for Target Time PPS1 status not detected
    eINACTIVE = 0,
    // Timestamp Target Time Reached for Target Time PPS1 status detected
    eACTIVE = 1,
  };
  ...
  enum class eTSTARGT2 : uint32_t {
    // Timestamp Target Time Reached for Target Time PPS2 status not detected
    eINACTIVE = 0,
    // Timestamp Target Time Reached for Target Time PPS2 status detected
    eACTIVE = 1,
  };
  ...
  enum class eTSTARGT3 : uint32_t {
    // Timestamp Target Time Reached for Target Time PPS3 status not detected
    eINACTIVE = 0,
    // Timestamp Target Time Reached for Target Time PPS3 status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXTSSIS : uint32_t {
    // Tx Timestamp Status Interrupt status not detected
    eINACTIVE = 0,
    // Tx Timestamp Status Interrupt status detected
    eACTIVE = 1,
  };
  ...
  enum class eATSSTM : uint32_t {
    // Auxiliary Timestamp Snapshot Trigger Missed status not detected
    eINACTIVE = 0,
...
union MAC_PPS_CONTROL {
  ...
  enum class ePPSEN0 : uint32_t {
    ...
    eDISABLE = 0,
    // Flexible PPS Output Mode is enabled
    eENABLE = 1,
  };
  ...
  enum class eTRGTMODSEL0 : uint32_t {
    // Target Time registers are programmed only for generating the interrupt event. The Flexible PPS function must not be enabled in this mode, otherwise spurious transitions may be observed on the corresponding ptp_pps_o output port
    eONLY_INT = 0,
    // Target Time registers are programmed for generating the interrupt event and starting or stopping the PPS0 output signal generation
    eINT_ST = 2,
  ...
  enum class eMCGREN0 : uint32_t {
    // 0th PPS instance is enabled to operate in PPS mode
    ePPS = 0,
    // 0th PPS instance is enabled to operate in MCGR mode
    eMCGR = 1,
  };
  ...
  enum class eMCGREN1 : uint32_t {
    // 1st PPS instance is disabled to operate in PPS or MCGR mode
    eDISABLE = 0,
    // 1st PPS instance is enabled to operate in PPS or MCGR mode
    eENABLE = 1,
  };
  ...
  enum class eMCGREN2 : uint32_t {
    // 2nd PPS instance is disabled to operate in PPS or MCGR mode
    eDISABLE = 0,
    // 2nd PPS instance is enabled to operate in PPS or MCGR mode
    eENABLE = 1,
  };
...
union MAC_PTO_CONTROL {
  ...
  enum class ePTOEN : uint32_t {
    ...
    eDISABLE = 0,
    // PTP Offload feature is enabled
    eENABLE = 1,
  };
  ...
  enum class eASYNCEN : uint32_t {
    // Automatic PTP SYNC message is disabled
    eDISABLE = 0,
    // Automatic PTP SYNC message is enabled
    eENABLE = 1,
  };
  ...
  enum class eAPDREQEN : uint32_t {
    // Automatic PTP Pdelay_Req message is disabled
    eDISABLE = 0,
    // Automatic PTP Pdelay_Req message is enabled
    eENABLE = 1,
  };
  ...
  enum class eASYNCTRIG : uint32_t {
    // Automatic PTP SYNC message Trigger is disabled
    eDISABLE = 0,
    // Automatic PTP SYNC message Trigger is enabled
    eENABLE = 1,
  };
  ...
  enum class eAPDREQTRIG : uint32_t {
    // Automatic PTP Pdelay_Req message Trigger is disabled
    eDISABLE = 0,
    // Automatic PTP Pdelay_Req message Trigger is enabled
    eENABLE = 1,
  };
  ...
  enum class eDRRDIS : uint32_t {
    // PTO Delay Request/Response response generation is enabled
    eENABLE = 0,
    // PTO Delay Request/Response response generation is disabled
    eDISABLE = 1,
  };
  ...
  enum class ePDRDIS : uint32_t {
    // Peer Delay Response response generation is enabled
    eENABLE = 0,
...
union MAC_LOG_MESSAGE_INTERVAL {
  ...
  enum class eDRSYNCR : uint32_t {
    ...
    eSYNC2 = 1,
    // for every 4 SYNC messages
    eSYNC4 = 2,
    // for every 8 SYNC messages
    eSYNC8 = 3,
    // for every 16 SYNC messages
    eSYNC16 = 4,
...
union MTL_OPERATION_MODE {
  ...
  enum class eDTXSTS : uint32_t {
    ...
    eDISABLE = 0,
    // Drop Transmit Status is enabled
    eENABLE = 1,
  };
  ...
  enum class eFRPE : uint32_t {
    // Flexible Rx parser is disabled
    eDISABLE = 0,
...
union MTL_DBG_CTL {
  ...
  enum class eDBGMOD : uint32_t {
    // Debug Mode Access to FIFO is disabled
    eDISABLE = 0,
    // Debug Mode Access to FIFO is enabled
    eENABLE = 1,
  };
  ...
  enum class ePKTSTATE : uint32_t {
    // Packet Data
    ePKT_DATA = 0,
    // Control Word/Normal Status
    eCW_NS = 1,
    // SOP Data/Last Status
    eSOP_LS = 2,
    // EOP Data/EOP
    eEOP = 3,
  };
  ...
  enum class eRSTALL : uint32_t {
    // Reset All Pointers is disabled
    eDISABLE = 0,
    // Reset All Pointers is enabled
    eENABLE = 1,
  };
  ...
  enum class eRSTSEL : uint32_t {
    // Reset Pointers of Selected FIFO is disabled
    eDISABLE = 0,
    // Reset Pointers of Selected FIFO is enabled
    eENABLE = 1,
  };
  ...
  enum class eFIFORDEN : uint32_t {
    // FIFO Read is disabled
    eDISABLE = 0,
    // FIFO Read is enabled
    eENABLE = 1,
  };
  ...
  enum class eFIFOWREN : uint32_t {
    // FIFO Write is disabled
    eDISABLE = 0,
    // FIFO Write is enabled
    eENABLE = 1,
  };
  ...
  enum class eFIFOSEL : uint32_t {
    // Tx FIFO
    eTXFIFO = 0,
    // Tx Status FIFO (only read access when SLVMOD is set)
    eTXSTSFIFO = 1,
    // TSO FIFO (cannot be accessed when SLVMOD is set)
    eTSOFIFO = 2,
    // Rx FIFO
    eRXFIFO = 3,
  };
  ...
  enum class ePKTIE : uint32_t {
    // Receive Packet Available Interrupt Status is disabled
    eDISABLE = 0,
    // Receive Packet Available Interrupt Status is enabled
    eENABLE = 1,
  };
  ...
  enum class eSTSIE : uint32_t {
    // Transmit Packet Available Interrupt Status is disabled
    eDISABLE = 0,
...
union MTL_DBG_STS {
  ...
  enum class ePKTI : uint32_t {
    // Receive Packet Available Interrupt Status not detected
    eINACTIVE = 0,
    // Receive Packet Available Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eSTSI : uint32_t {
    // Transmit Status Available Interrupt Status not detected
    eINACTIVE = 0,
...
union MTL_INTERRUPT_STATUS {
  ...
  enum class eMTLPIS : uint32_t {
    // MTL Rx Parser Interrupt status not detected
    eINACTIVE = 0,
...
union MTL_RXQ_DMA_MAP0 {
  ...
  enum class eQ1DDMACH : uint32_t {
    // Queue 1 disabled for DA-based DMA Channel Selection
    eDISABLE = 0,
  ...
  enum class eQ2DDMACH : uint32_t {
    // Queue 2 disabled for DA-based DMA Channel Selection
    eDISABLE = 0,
    // Queue 2 enabled for DA-based DMA Channel Selection
    eENABLE = 1,
  };
  ...
  enum class eQ3DDMACH : uint32_t {
    // Queue 3 disabled for DA-based DMA Channel Selection
    eDISABLE = 0,
...
union MTL_EST_GCL_CONTROL {
  ...
  enum class eESTEIEE : uint32_t {
    // EST ECC Inject Error is disabled
    eDISABLE = 0,
    // EST ECC Inject Error is enabled
    eENABLE = 1,
  };
...
union MTL_RXP_INTERRUPT_CONTROL_STATUS {
  ...
  enum class eNVEOVIS : uint32_t {
    ...
    eINACTIVE = 0,
    // Number of Valid Entries Overflow Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eNPEOVIS : uint32_t {
    // Number of Parsable Entries Overflow Interrupt Status not detected
    eINACTIVE = 0,
    // Number of Parsable Entries Overflow Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eFOOVIS : uint32_t {
    // Frame Offset Overflow Interrupt Status not detected
    eINACTIVE = 0,
    // Frame Offset Overflow Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class ePDRFIS : uint32_t {
    // Packet Dropped due to RF Interrupt Status not detected
    eINACTIVE = 0,
    // Packet Dropped due to RF Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eNVEOVIE : uint32_t {
    // Number of Valid Entries Overflow Interrupt is disabled
    eDISABLE = 0,
    // Number of Valid Entries Overflow Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eNPEOVIE : uint32_t {
    // Number of Parsable Entries Overflow Interrupt is disabled
    eDISABLE = 0,
    // Number of Parsable Entries Overflow Interrupt is enabled
    eENABLE = 1,
  };
  
  // Frame Offset Overflow Interrupt Enable When this bit is set, the FOOVIS interrupt is enabled.
  enum class eFOOVIE : uint32_t {
    // Frame Offset Overflow Interrupt is disabled
    eDISABLE = 0,
    // Frame Offset Overflow Interrupt is enabled
    eENABLE = 1,
  };
  
  // Packet Drop due to RF Interrupt Enable When this bit is set, the PDRFIS interrupt is enabled.
  enum class ePDRFIE : uint32_t {
    // Packet Drop due to RF Interrupt is disabled
    eDISABLE = 0,
...
union MTL_TXQ0_OPERATION_MODE {
  ...
  enum class eFTQ : uint32_t {
    ...
    eDISABLE = 0,
    // Flush Transmit Queue is enabled
    eENABLE = 1,
  };
  ...
  enum class eTSF : uint32_t {
    // Transmit Store and Forward is disabled
    eDISABLE = 0,
    // Transmit Store and Forward is enabled
    eENABLE = 1,
  };
  ...
  enum class eTXQEN : uint32_t {
    // Not enabled
    eDISABLE = 0,
    // Enable in AV mode (Reserved in non-AV)
    eEN_IF_AV = 1,
    // Enabled
    eENABLE = 2,
  };
...
union MTL_TXQ0_DEBUG {
  ...
  enum class eTXQPAUSED : uint32_t {
    ...
    eINACTIVE = 0,
    // Transmit Queue in Pause status is detected
    eACTIVE = 1,
  };
  ...
  enum class eTWCSTS : uint32_t {
    // MTL Tx Queue Write Controller status is not detected
    eINACTIVE = 0,
    // MTL Tx Queue Write Controller status is detected
    eACTIVE = 1,
  };
  ...
  enum class eTXQSTS : uint32_t {
    // MTL Tx Queue Not Empty status is not detected
    eINACTIVE = 0,
    // MTL Tx Queue Not Empty status is detected
    eACTIVE = 1,
  };
  ...
  enum class eTXSTSFSTS : uint32_t {
    // MTL Tx Status FIFO Full status is not detected
    eINACTIVE = 0,
...
union MTL_Q0_INTERRUPT_CONTROL_STATUS {
  ...
  enum class eTXUNFIS : uint32_t {
    ...
    eINACTIVE = 0,
    // Transmit Queue Underflow Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eABPSIS : uint32_t {
    // Average Bits Per Slot Interrupt Status not detected
    eINACTIVE = 0,
    // Average Bits Per Slot Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eTXUIE : uint32_t {
    // Transmit Queue Underflow Interrupt Status is disabled
    eDISABLE = 0,
    // Transmit Queue Underflow Interrupt Status is enabled
    eENABLE = 1,
  };
  ...
  enum class eABPSIE : uint32_t {
    // Average Bits Per Slot Interrupt is disabled
    eDISABLE = 0,
    // Average Bits Per Slot Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eRXOVFIS : uint32_t {
    // Receive Queue Overflow Interrupt Status not detected
    eINACTIVE = 0,
    // Receive Queue Overflow Interrupt Status detected
    eACTIVE = 1,
  };
  ...
  enum class eRXOIE : uint32_t {
    // Receive Queue Overflow Interrupt is disabled
    eDISABLE = 0,
...
union MTL_RXQ0_OPERATION_MODE {
  ...
  enum class eFUP : uint32_t {
    // Forward Undersized Good Packets is disabled
    eDISABLE = 0,
    // Forward Undersized Good Packets is enabled
    eENABLE = 1,
  };
  ...
  enum class eFEP : uint32_t {
    // Forward Error Packets is disabled
    eDISABLE = 0,
    // Forward Error Packets is enabled
    eENABLE = 1,
  };
  ...
  enum class eRSF : uint32_t {
    // Receive Queue Store and Forward is disabled
    eDISABLE = 0,
    // Receive Queue Store and Forward is enabled
    eENABLE = 1,
  };
...
union MTL_RXQ0_MISSED_PACKET_OVERFLOW_CNT {
  ...
  enum class eMISCNTOVF : uint32_t {
    // Missed Packet Counter overflow not detected
    eINACTIVE = 0,
...
union MTL_RXQ0_DEBUG {
  ...
  enum class eRWCSTS : uint32_t {
    ...
    eINACTIVE = 0,
    // MTL Rx Queue Write Controller Active Status detected
    eACTIVE = 1,
  };
...
union DMA_MODE {
  ...
  enum class eDSPW : uint32_t {
    // Descriptor Posted Write is disabled
    eDISABLE = 0,
...
union DMA_SYSBUS_MODE {
  ...
  enum class eAALE : uint32_t {
    // Automatic AXI LPI is disabled
    eDISABLE = 0,
    // Automatic AXI LPI is enabled
    eENABLE = 1,
  };
  ...
  enum class eAAL : uint32_t {
    // Address-Aligned Beats is disabled
    eDISABLE = 0,
    // Address-Aligned Beats is enabled
    eENABLE = 1,
  };
  ...
  enum class eONEKBBE : uint32_t {
    // 1 KB Boundary Crossing for the EQOS-AXI Master Beats is disabled
    eDISABLE = 0,
    // 1 KB Boundary Crossing for the EQOS-AXI Master Beats is enabled
    eENABLE = 1,
  };
  ...
  enum class eLPI_XIT_PKT : uint32_t {
    // Unlock on Magic Packet or Remote Wake-Up Packet is disabled
    eDISABLE = 0,
    // Unlock on Magic Packet or Remote Wake-Up Packet is enabled
    eENABLE = 1,
  };
  ...
  enum class eEN_LPI : uint32_t {
    // Low Power Interface (LPI) is disabled
    eDISABLE = 0,
...
union DMA_DEBUG_STATUS0 {
  ...
  enum class eAXWHSTS : uint32_t {
    ...
    eINACTIVE = 0,
    // AXI Master Write Channel or AHB Master Status detected
    eACTIVE = 1,
  };
  ...
  enum class eAXRHSTS : uint32_t {
    // AXI Master Read Channel Status not detected
    eINACTIVE = 0,
    // AXI Master Read Channel Status detected
    eACTIVE = 1,
  };
...
union DMA_CH0_TX_CONTROL {
  ...
  enum class eOSF : uint32_t {
    // Operate on Second Packet disabled
    eDISABLE = 0,
  ...
  enum class eIPBL : uint32_t {
    // Ignore PBL Requirement is disabled
    eDISABLE = 0,
  ...
  enum class eEDSE : uint32_t {
    // Enhanced Descriptor is disabled
    eDISABLE = 0,
...
union DMA_CH0_INTERRUPT_ENABLE {
  ...
  enum class eTXSE : uint32_t {
    // Transmit Stopped is disabled
    eDISABLE = 0,
    // Transmit Stopped is enabled
    eENABLE = 1,
  };
  ...
  enum class eTBUE : uint32_t {
    // Transmit Buffer Unavailable is disabled
    eDISABLE = 0,
    // Transmit Buffer Unavailable is enabled
    eENABLE = 1,
  };
  ...
  enum class eRBUE : uint32_t {
    // Receive Buffer Unavailable is disabled
    eDISABLE = 0,
    // Receive Buffer Unavailable is enabled
    eENABLE = 1,
  };
  ...
  enum class eRSE : uint32_t {
    // Receive Stopped is disabled
    eDISABLE = 0,
    // Receive Stopped is enabled
    eENABLE = 1,
  };
  ...
  enum class eRWTE : uint32_t {
    // Receive Watchdog Timeout is disabled
    eDISABLE = 0,
    // Receive Watchdog Timeout is enabled
    eENABLE = 1,
  };
  ...
  enum class eETIE : uint32_t {
    ...
    eDISABLE = 0,
    // Early Transmit Interrupt is enabled
    eENABLE = 1,
  };
  ...
  enum class eFBEE : uint32_t {
    // Fatal Bus Error is disabled
    eDISABLE = 0,
    // Fatal Bus Error is enabled
    eENABLE = 1,
  };
  ...
  enum class eCDEE : uint32_t {
    // Context Descriptor Error is disabled
    eDISABLE = 0,
    // Context Descriptor Error is enabled
    eENABLE = 1,
  };
...
union DMA_CH0_STATUS {
  ...
  enum class eTI : uint32_t {
    ...
    eINACTIVE = 0,
    // Transmit Interrupt status detected
    eACTIVE = 1,
  };
  
  // Transmit Process Stopped This bit is set when the transmission is stopped.
  enum class eTPS : uint32_t {
    // Transmit Process Stopped status not detected
    eINACTIVE = 0,
    // Transmit Process Stopped status detected
    eACTIVE = 1,
  };
  ...
  enum class eTBU : uint32_t {
    // Transmit Buffer Unavailable status not detected
    eINACTIVE = 0,
    // Transmit Buffer Unavailable status detected
    eACTIVE = 1,
  };
  
  // Receive Interrupt This bit indicates that the packet reception is complete.
  enum class eRI : uint32_t {
    // Receive Interrupt status not detected
    eINACTIVE = 0,
  ...
  enum class eRBU : uint32_t {
    // Receive Buffer Unavailable status not detected
    eINACTIVE = 0,
    // Receive Buffer Unavailable status detected
    eACTIVE = 1,
  };
  
  // Receive Process Stopped This bit is asserted when the Rx process enters the Stopped state.
  enum class eRPS : uint32_t {
    // Receive Process Stopped status not detected
    eINACTIVE = 0,
    // Receive Process Stopped status detected
    eACTIVE = 1,
  };
  ...
  enum class eRWT : uint32_t {
    // Receive Watchdog Timeout status not detected
    eINACTIVE = 0,
    // Receive Watchdog Timeout status detected
    eACTIVE = 1,
  };
  ...
  enum class eETI : uint32_t {
    // Early Transmit Interrupt status not detected
    eINACTIVE = 0,
    // Early Transmit Interrupt status detected
    eACTIVE = 1,
  };
  ...
  enum class eERI : uint32_t {
    // Early Receive Interrupt status not detected
    eINACTIVE = 0,
    // Early Receive Interrupt status detected
    eACTIVE = 1,
  };
  
  // Fatal Bus Error This bit indicates that a bus error occurred (as described in the EB field).
  enum class eFBE : uint32_t {
    // Fatal Bus Error status not detected
    eINACTIVE = 0,
    // Fatal Bus Error status detected
    eACTIVE = 1,
  };
  ...
  enum class eCDE : uint32_t {
    // Context Descriptor Error status not detected
    eINACTIVE = 0,
    // Context Descriptor Error status detected
    eACTIVE = 1,
  };
  ...
  enum class eAIS : uint32_t {
    // Abnormal Interrupt Summary status not detected
    eINACTIVE = 0,
    // Abnormal Interrupt Summary status detected
    eACTIVE = 1,
  };
  ...
  enum class eNIS : uint32_t {
    // Normal Interrupt Summary status not detected
    eINACTIVE = 0,
