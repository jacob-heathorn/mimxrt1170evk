...
union MIF_AUTHEN_CTRL {
  ...
  static inline volatile MIF_AUTHEN_CTRL &Instance() { return *reinterpret_cast<volatile MIF_AUTHEN_CTRL*>(0x40C89104); }
};
...
union MIF_MLPL_SLEEP {
  ...
  static inline volatile MIF_MLPL_SLEEP &Instance() { return *reinterpret_cast<volatile MIF_MLPL_SLEEP*>(0x40C89110); }
};
...
union MIF_MLPL_IG {
  ...
  static inline volatile MIF_MLPL_IG &Instance() { return *reinterpret_cast<volatile MIF_MLPL_IG*>(0x40C89120); }
};
...
union MIF_MLPL_LS {
  ...
  static inline volatile MIF_MLPL_LS &Instance() { return *reinterpret_cast<volatile MIF_MLPL_LS*>(0x40C89130); }
};
...
union MIF_MLPL_HS {
  ...
  static inline volatile MIF_MLPL_HS &Instance() { return *reinterpret_cast<volatile MIF_MLPL_HS*>(0x40C89140); }
};
...
union MIF_MLPL_STDBY {
  ...
  static inline volatile MIF_MLPL_STDBY &Instance() { return *reinterpret_cast<volatile MIF_MLPL_STDBY*>(0x40C89150); }
};
...
union MIF_MLPL_ARR_PDN {
  ...
  static inline volatile MIF_MLPL_ARR_PDN &Instance() { return *reinterpret_cast<volatile MIF_MLPL_ARR_PDN*>(0x40C89160); }
};
...
union MIF_MLPL_PER_PDN {
  ...
  static inline volatile MIF_MLPL_PER_PDN &Instance() { return *reinterpret_cast<volatile MIF_MLPL_PER_PDN*>(0x40C89170); }
};
...
union MIF_MLPL_INITN {
  ...
  static inline volatile MIF_MLPL_INITN &Instance() { return *reinterpret_cast<volatile MIF_MLPL_INITN*>(0x40C89180); }
};
...
union MIF_MLPL_ISO {
  ...
  static inline volatile MIF_MLPL_ISO &Instance() { return *reinterpret_cast<volatile MIF_MLPL_ISO*>(0x40C891B0); }
};
